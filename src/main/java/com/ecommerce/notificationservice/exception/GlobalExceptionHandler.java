...
import com.ecommerce.notificationservice.dto.response.ApiErrorResponseDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponseDTO> methodArgumentNotValidExceptionHandler(MethodArgumentNotValidException e) {
